...
class PostController{
    ...
    formatDateToYYYYMMDD(date) {
        ...
        const year = date.toLocaleString('en-US', { timeZone: 'Asia/Seoul', year: 'numeric' });
        const month = String(date.toLocaleString('en-US', { timeZone: 'Asia/Seoul', month: '2-digit' })).padStart(2, '0');
        const day = String(date.toLocaleString('en-US', { timeZone: 'Asia/Seoul', day: '2-digit' })).padStart(2, '0');
